...
'''
The `Email_Dataset()` class contains all processes needed to split a dataset into training, testing, and evaluation data.
'''
class Email_Dataset():
    '''
    ...
    '''
    def __init__(self, responded, sent, userbase):
        responded_df = deepcopy(responded)
        sent_df = deepcopy(sent)
        userbase_df = deepcopy(userbase)
