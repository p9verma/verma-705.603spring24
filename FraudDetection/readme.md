...
* ML microservice: Deliverable_G.ipynb and Deliverable_G_run.ipynb contain the code to run the ml microservice (via flask app) defined in [ml_microservice.py](analysis/ml_microserivce.py)
